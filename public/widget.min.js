"use strict";(()=>{(function(){"use strict";const Y=["image/jpeg","image/png","image/gif","image/webp","application/pdf","text/plain","text/csv","text/markdown","application/vnd.openxmlformats-officedocument.wordprocessingml.document","application/vnd.openxmlformats-officedocument.spreadsheetml.sheet"],v={primaryColor:"#001F54",accentColor:"#3B82F6",animationEnabled:!0,animationCycles:6},C={FREQUENCY_THRESHOLD_DB:-100,FREQUENCY_SCALE_FACTOR:11.7185,FREQUENCY_DIVISOR:24e3,FREQUENCY_SPEED_MULTIPLIER:.5,AMPLITUDE_SCALE:10},x={RIPPLE_CYCLES:3,INITIAL_DELAY:1e3,STAGGER_DELAY:150,CYCLE_PAUSE:500,BOUNCE_DURATION:500};let I=!1;function S(){if(I)return;const c=document.createElement("style");c.textContent=`
    ...
    `,document.head.appendChild(c),I=!0}function G(c,e){var r,a;if(!((r=e==null?void 0:e.animationEnabled)!=null?r:v.animationEnabled)){console.log("[Widget] Animation disabled in settings");return}if(!c||c.length===0)return;S();const i=c.map(l=>l.querySelector("svg")).filter(Boolean);if(i.length===0)return;const t=(a=e==null?void 0:e.animationCycles)!=null?a:v.animationCycles;let n=0;console.log("[Widget] Starting animation with",t,"cycles");function s(){if(!(n>=t)&&(i.forEach((l,p)=>{const g=p*x.STAGGER_DELAY;setTimeout(()=>{l.classList.remove("lbs-icon-bouncing"),l.offsetWidth,l.classList.add("lbs-icon-bouncing"),setTimeout(()=>{l.classList.remove("lbs-icon-bouncing")},x.BOUNCE_DURATION)},g)}),n++,n<t)){const l=i.length*x.STAGGER_DELAY+x.BOUNCE_DURATION;setTimeout(s,l+x.CYCLE_PAUSE)}}setTimeout(s,x.INITIAL_DELAY)}function X(c,e){var s,r;if(!((s=e==null?void 0:e.animationEnabled)!=null?s:v.animationEnabled)){console.log("[Widget] Single button animation disabled in settings");return}if(!c)return;S();const i=(r=e==null?void 0:e.animationCycles)!=null?r:v.animationCycles;let t=0;console.log("[Widget] Starting single button animation with",i,"cycles");function n(){t>=i||(c.classList.remove("lbs-icon-bouncing"),c.offsetWidth,c.classList.add("lbs-icon-bouncing"),setTimeout(()=>{c.classList.remove("lbs-icon-bouncing")},x.BOUNCE_DURATION),t++,t<i&&setTimeout(n,x.BOUNCE_DURATION+x.CYCLE_PAUSE))}setTimeout(n,x.INITIAL_DELAY)}function J(c){return Y.includes(c.type)?c.size>52428800?{valid:!1,error:`File too large: ${c.name}. Maximum size is 50MB`}:{valid:!0}:{valid:!1,error:`Unsupported file type: ${c.name}. Supported: PDF, images, text, DOCX, XLSX`}}function Q(c){return new Promise((e,o)=>{const i=new FileReader;i.readAsDataURL(c),i.onload=()=>{if(typeof i.result=="string"){const t=i.result.split(",")[1];e(t)}else o(new Error("Failed to convert file to base64"))},i.onerror=t=>o(t)})}function B(c){if(c===0)return"0 Bytes";const e=1024,o=["Bytes","KB","MB","GB"],i=Math.floor(Math.log(c)/Math.log(e));return parseFloat((c/Math.pow(e,i)).toFixed(2))+" "+o[i]}function T(c){return c==="application/pdf"?"\u{1F4C4}":c.startsWith("image/")?"\u{1F5BC}\uFE0F":c.startsWith("text/")?"\u{1F4DD}":c.includes("spreadsheet")||c.includes("excel")?"\u{1F4CA}":c.includes("word")||c.includes("document")?"\u{1F4C3}":"\u{1F4CE}"}const D=["Thinking...","Processing...","Analyzing...","Considering...","Evaluating...","Pondering...","Contemplating...","Reflecting...","Reasoning...","Deliberating...","Examining...","Assessing...","Reviewing...","Calculating...","Formulating..."];function K(){const c=Math.floor(Math.random()*D.length);return D[c]}function h(c){return c?String(c).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;"):""}function $(c,e="error",o=5e3){let i=document.getElementById("lbs-toast-container");i||(i=document.createElement("div"),i.id="lbs-toast-container",i.style.cssText=`
        position: fixed;
        bottom: 100px;
        right: 24px;
        z-index: 10001;
      ...
      <div class="lbs-toast-content">
        <p class="lbs-toast-message">${h(c)}</p>
      </div>
    ...
    `;const s=t.querySelector(".lbs-toast-close");return s.onclick=()=>M(t),i.appendChild(t),requestAnimationFrame(()=>{t.classList.add("lbs-toast-visible")}),o>0&&setTimeout(()=>M(t),o),t}function M(c){!c||!c.parentNode||(c.classList.remove("lbs-toast-visible"),c.classList.add("lbs-toast-hiding"),setTimeout(()=>{c.parentNode&&c.parentNode.removeChild(c)},200))}function Z(c){switch(c){case"error":return`<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
      ...
      `;const t=document.getElementById("lbs-sidebar-close"),n=document.getElementById("lbs-sidebar-new-btn");t&&(t.onclick=()=>this.toggleSidebar()),n&&(n.onclick=()=>{this.startNewConversation()},n.onmouseover=()=>{n.style.opacity="0.9"},n.onmouseout=()=>{n.style.opacity="1"}),e.querySelectorAll("[data-conversation-id]").forEach(a=>{const l=a.getAttribute("data-conversation-id");l&&(a.onclick=()=>this.switchConversation(l),a.onmouseover=()=>{l!==this.currentConversationId&&(a.style.background="#f9fafb")},a.onmouseout=()=>{l!==this.currentConversationId&&(a.style.background="white")})}),e.querySelectorAll("[data-delete-conversation]").forEach(a=>{const l=a.getAttribute("data-delete-conversation");l&&(a.onclick=p=>{p.stopPropagation(),this.showDeleteConfirmationModal(l)})})}renderConversationGroups(e){const o=Date.now(),i={Today:[],Yesterday:[],"Last 7 days":[],Older:[]};for(const n of e){const r=(o-n.lastMessageAt)/(24*60*60*1e3);r<1?i.Today.push(n):r<2?i.Yesterday.push(n):r<7?i["Last 7 days"].push(n):i.Older.push(n)}let t="";for(const[n,s]of Object.entries(i))s.length>0&&(t+=`
            <div style="margin-bottom: 16px;">
      ...
      `,e.style.cssText=`
        ...
        margin-bottom: 20px;
      `,e.onmouseover=()=>{e.style.transform="scale(1.1)"},e.onmouseout=()=>{e.style.transform="scale(1)"},e.onclick=()=>this.toggleChat();const o=this.appearance;return setTimeout(()=>{X(e,o)},100),e}createChatWindow(){const e=document.createElement("div");e.id="lbs-chat-window";const o=this.config.position.includes("right"),i=this.hasMultipleActions(),n=i?`${(i?64:0)+8}px`:"100px",s=`calc(100vh - 650px - ${n})`,r=o?"calc(100vw - 400px - 20px)":"20px",a=o?"20px":"calc(100vw - 400px - 20px)";e.style.cssText=`
        display: none;
        position: fixed;
        top: ${s};
        bottom: ${n};
      ...
      `;const l=document.createElement("div");return l.id="lbs-chat-content",l.style.cssText=`
        width: 100%;
        height: 100%;
        position: relative;
        overflow: hidden;
      `,e.appendChild(l),e}attachEventListeners(){}renderCurrentView(){const e=document.getElementById("lbs-chat-content");e&&(e.style.opacity="0",e.style.transition="opacity 0.2s ease-in-out",setTimeout(()=>{this.currentView==="profile"?(e.innerHTML=this.createProfileView(),this.attachProfileEventListeners()):this.currentView==="booking"?(e.innerHTML=this.createBookingView(),this.attachBookingEventListeners()):this.currentView==="text"?(e.innerHTML=this.createTextView(),this.attachTextEventListeners()):(e.innerHTML=this.createChatView(),this.attachChatEventListeners(),this.renderStoredMessages()),setTimeout(()=>{e.style.opacity="1"},50)},200))}createProfileView(){var t,n,s,r,a;const e=ie((t=this.chatbot)==null?void 0:t.name),o=(n=this.chatbot)==null?void 0:n.thumbnail,i=((s=this.chatbot)==null?void 0:s.suggestedQuestions)||[];return`
        <div style="display: flex; flex-direction: column; height: 100%; background: white; align-items: center;">
          ...
          <div style="width: 100%; max-width: 600px; display: flex; flex-direction: column; height: 100%;">
            ...
            <h2 style="margin: 0 0 4px 0; font-size: 20px; font-weight: 600; color: #111827; text-align: center;">
              ${h(((r=this.chatbot)==null?void 0:r.name)||"AI Assistant")}
            </h2>
          ...
          ${i.length>0?`
            ...
            <div style="flex: 1; overflow-y: auto; padding: 0 24px 24px; min-height: 0;">
              ...
              <div style="display: flex; flex-direction: column; gap: 8px;">
                ${i.map((l,p)=>`
                  <button class="suggested-question-btn" data-question="${h(l)}" style="
                    padding: 12px 16px;
                    background: white;
      ...
      `}attachProfileEventListeners(){const e=document.getElementById("lbs-minimize-btn"),o=document.getElementById("lbs-expand-btn"),i=document.getElementById("lbs-fullscreen-minimize-btn"),t=document.getElementById("lbs-start-chat-btn"),n=document.getElementById("lbs-start-booking-btn"),s=document.getElementById("lbs-start-text-btn"),r=document.querySelectorAll(".suggested-question-btn");if(e&&(e.onclick=()=>this.toggleChat()),o&&(o.onclick=()=>this.toggleFullscreen()),i&&(i.onclick=()=>this.toggleFullscreen()),n&&(n.onclick=()=>{this.bookingStep=1,this.bookingData={categoryId:null,categoryName:null,subCategoryId:null,subCategoryName:null,caseDescription:"",firstName:"",lastName:"",email:"",phone:"",locationId:null,locationName:null,locationAddress:null,appointmentDate:null,appointmentTime:null},this.currentView="booking",this.renderCurrentView()},n.onmouseover=()=>{n.style.background=this.lightenColor(this.appearance.primaryColor,10)},n.onmouseout=()=>{n.style.background=this.appearance.primaryColor}),s){s.onclick=()=>{this.textData={firstName:"",lastName:"",email:"",phone:"",message:""},this.currentView="text",this.renderCurrentView()};const a=this.isBookingEnabled();s.onmouseover=()=>{a?s.style.background="#f9fafb":s.style.background=this.lightenColor(this.appearance.primaryColor,10)},s.onmouseout=()=>{a?s.style.background="white":s.style.background=this.appearance.primaryColor}}if(t){t.onclick=()=>{var l;this.currentView="chat",this.renderCurrentView(),this.messages.length===0&&((l=this.chatbot)!=null&&l.chatGreeting)&&setTimeout(()=>{this.renderMessage("assistant",this.chatbot.chatGreeting)},300)};const a=this.isBookingEnabled()||this.isTextEnabled();t.onmouseover=()=>{a?t.style.background="#f9fafb":t.style.background=this.lightenColor(this.appearance.accentColor,10)},t.onmouseout=()=>{a?t.style.background="white":t.style.background=this.appearance.accentColor}}r.forEach(a=>{a.onclick=()=>{const l=a.getAttribute("data-question");this.currentView="chat",this.renderCurrentView(),setTimeout(()=>{var g;this.messages.length===0&&((g=this.chatbot)!=null&&g.chatGreeting)&&this.renderMessage("assistant",this.chatbot.chatGreeting);const p=document.getElementById("lbs-chat-input");p&&(p.value=l,p.focus())},300)},a.onmouseover=()=>{a.style.background="#f9fafb",a.style.borderColor=this.appearance.accentColor},a.onmouseout=()=>{a.style.background="white",a.style.borderColor="#e5e7eb"}})}createBookingView(){var s;const o={1:"What can we help you with?",2:"Select a specific service",3:"Tell us about your case",4:"Your contact information",5:"Select a location",6:"Choose date and time",7:"Confirm your appointment"}[this.bookingStep]||"Schedule Appointment",i=((s=this.bookingConfig)==null?void 0:s.requireCaseDescription)!==!1?7:6;let t="";if(this.bookingStep===1)t=this.bookingConfig.categories.map(r=>`
        ...
        `).join("");else if(this.bookingStep===2){const r=this.bookingConfig.categories.find(l=>l.id===this.bookingData.categoryId);t=((r==null?void 0:r.subCategories)||[]).map(l=>`
          <button class="booking-subcategory-btn" data-subcategory-id="${h(l.id)}" data-subcategory-name="${h(l.name)}" style="
            width: 100%;
            padding: 16px;
            background: white;
            border: 1px solid #e5e7eb;
        ...
        `).join("");else if(this.bookingStep===6){const r=this.bookingConfig.locations.find(m=>m.id===this.bookingData.locationId),a=(r==null?void 0:r.availableDays)||[],l=(r==null?void 0:r.timeSlots)||[],p=[],g=new Date;for(let m=1;m<=30&&p.length<14;m++){const d=new Date(g);d.setDate(g.getDate()+m);const u=d.toLocaleDateString("en-US",{weekday:"long"}).toLowerCase();a.includes(u)&&p.push(d)}t=`
          <div style="margin-bottom: 16px;">
            <label style="display: block; font-size: 14px; font-weight: 500; color: #374151; margin-bottom: 8px;">Select Date *</label>
            <div style="display: flex; flex-wrap: wrap; gap: 8px;">
              ${p.map(m=>{const d=m.toISOString().split("T")[0],u=this.bookingData.appointmentDate===d;return`
                    <button class="booking-date-btn" data-date="${d}" style="
                      ...
                      transition: all 0.2s;
                    ">
                      <div style="font-weight: 500;">${m.toLocaleDateString("en-US",{weekday:"short"})}</div>
                      <div>${m.toLocaleDateString("en-US",{month:"short",day:"numeric"})}</div>
                    </button>
                  `}).join("")}
            </div>
          </div>
          ...
          <div>
            ...
            <div style="display: flex; flex-wrap: wrap; gap: 8px;">
              ${l.map(m=>{const d=this.bookingData.appointmentTime===m.start;return`
                    <button class="booking-time-btn" data-time="${h(m.start)}" style="
                      padding: 10px 16px;
        ...
        <div style="display: flex; flex-direction: column; height: 100%; background: white;">
          ...
          <div style="display: flex; justify-content: center; gap: 6px; padding: 12px;">
            ${Array.from({length:i},(r,a)=>{const l=a+1,p=l===this.bookingStep,g=l<this.bookingStep;return`<div style="width: 8px; height: 8px; border-radius: 50%; background: ${p||g?this.appearance.primaryColor:"#e5e7eb"};"></div>`}).join("")}
          </div>
      ...
      `;const i=document.getElementById("booking-done-btn");i&&(i.onclick=()=>{this.currentView="profile",this.renderCurrentView()})}createTextView(){var l,p,g,m,d,u,b,f;const e=((l=this.textConfig)==null?void 0:l.fields)||{},o=((p=this.textConfig)==null?void 0:p.consentText)||"By submitting this form, you consent to receive text messages from us. Message and data rates may apply.",i=((g=e.firstName)==null?void 0:g.required)!==!1,t=((m=e.lastName)==null?void 0:m.required)!==!1,n=((d=e.phone)==null?void 0:d.required)!==!1,s=((u=e.email)==null?void 0:u.enabled)!==!1,r=((b=e.email)==null?void 0:b.required)===!0,a=((f=e.message)==null?void 0:f.required)!==!1;return`
        <div style="display: flex; flex-direction: column; height: 100%; background: white;">
          <!-- Header -->
          <div style="padding: 16px; border-bottom: 1px solid #e5e7eb; display: flex; justify-content: space-between; align-items: center;">
          ...
          <div style="flex: 1; overflow-y: auto; padding: 24px;">
            <div style="display: flex; flex-direction: column; gap: 16px;">
              ...
              <!-- Message -->
              <div>
                <label style="display: block; font-size: 14px; font-weight: 500; color: #374151; margin-bottom: 6px;">Message${a?" *":""}</label>
      ...
      `}attachTextEventListeners(){const e=document.getElementById("text-back-btn"),o=document.getElementById("text-close-btn"),i=document.getElementById("text-submit-btn");e&&(e.onclick=()=>{this.currentView="profile",this.renderCurrentView()}),o&&(o.onclick=()=>{this.currentView="profile",this.renderCurrentView()}),i&&(i.onclick=async()=>{await this.submitTextRequest()},i.onmouseover=()=>{i.style.background=this.lightenColor(this.appearance.primaryColor,10)},i.onmouseout=()=>{i.style.background=this.appearance.primaryColor})}async submitTextRequest(){var y,E,w,N,F,L,R,_,H,V,O,j,P,W,q,U;const e=document.getElementById("text-submit-btn"),o=document.getElementById("text-error"),i=(E=(y=document.getElementById("text-first-name"))==null?void 0:y.value)==null?void 0:E.trim(),t=(N=(w=document.getElementById("text-last-name"))==null?void 0:w.value)==null?void 0:N.trim(),n=(L=(F=document.getElementById("text-phone"))==null?void 0:F.value)==null?void 0:L.trim(),s=document.getElementById("text-email"),r=((R=s==null?void 0:s.value)==null?void 0:R.trim())||"",a=(H=(_=document.getElementById("text-message"))==null?void 0:_.value)==null?void 0:H.trim(),l=((V=this.textConfig)==null?void 0:V.fields)||{},p=((O=l.firstName)==null?void 0:O.required)!==!1,g=((j=l.lastName)==null?void 0:j.required)!==!1,m=((P=l.phone)==null?void 0:P.required)!==!1,d=((W=l.email)==null?void 0:W.enabled)!==!1,u=((q=l.email)==null?void 0:q.required)===!0,b=((U=l.message)==null?void 0:U.required)!==!1,f=[];if(p&&!i&&f.push("First name is required"),g&&!t&&f.push("Last name is required"),m&&!n&&f.push("Phone number is required"),d&&u&&!r&&f.push("Email is required"),d&&r&&(/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(r)||f.push("Please enter a valid email address")),b&&!a&&f.push("Message is required"),f.length>0){o&&(o.textContent=f[0],o.style.display="block");return}this.textData={firstName:i,lastName:t,email:r,phone:n,message:a},e&&(e.disabled=!0,e.textContent="Sending...");try{const k=await fetch(`${this.config.apiUrl}/api/public/chatbots/${this.config.chatbotId}/text-requests`,{method:"POST",headers:{"Content-Type":"application/json","ngrok-skip-browser-warning":"true"},body:JSON.stringify({sessionId:this.sessionId||this.generateId(),firstName:i,lastName:t,email:r||void 0,phone:n,message:a})});if(!k.ok){const ne=await k.json().catch(()=>({}));throw new Error(ne.error||"Failed to submit text request")}this.showTextSuccess()}catch(k){console.error("Text request submission error:",k),o&&(o.textContent=k.message||"Failed to send message. Please try again.",o.style.display="block"),e&&(e.disabled=!1,e.textContent="Send Message")}}showTextSuccess(){const e=document.getElementById("lbs-chat-content");if(!e)return;e.innerHTML=`
        <div style="display: flex; flex-direction: column; height: 100%; background: white; align-items: center; justify-content: center; padding: 24px; text-align: center;">
          <div style="width: 80px; height: 80px; background: #d1fae5; border-radius: 50%; display: flex; align-items: center; justify-content: center; margin-bottom: 24px;">
            <svg width="40" height="40" viewBox="0 0 24 24" fill="none" stroke="#10b981" stroke-width="3">
              <polyline points="20 6 9 17 4 12"></polyline>
      ...
      `,e==="assistant"){const n=document.createElement("div");n.className="widget-message-wrapper",n.style.cssText=`
        ...
        `;const s=document.createElement("div");s.className=`widget-bubble widget-bubble-${e}`,s.style.cssText=`
          ...
          color: #1f2937;
          border: 1px solid #e5e7eb;
        `,s.innerHTML=z(o);const r=document.createElement("button");r.className="widget-copy-button",r.setAttribute("aria-label","Copy message"),r.innerHTML=`
          <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
            <rect x="9" y="9" width="13" height="13" rx="2" ry="2"></rect>
            <path d="M5 15H4a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h9a2 2 0 0 1 2 2v1"></path>
          </svg>
        `,r.onclick=()=>{const a=document.createElement("div");a.innerHTML=s.innerHTML;const l=a.textContent||a.innerText||"";navigator.clipboard.writeText(l).then(()=>{const p=r.innerHTML;r.innerHTML=`
              <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                <polyline points="20 6 9 17 4 12"></polyline>
              </svg>
            `,setTimeout(()=>{r.innerHTML=p},2e3)}).catch(p=>{console.error("Failed to copy text:",p)})},n.appendChild(s),n.appendChild(r),t.appendChild(n)}else{const n=document.createElement("div");n.className=`widget-bubble widget-bubble-${e}`,n.style.cssText=`
          max-width: 80%;
          padding: 10px 14px;
          border-radius: 12px;
          font-size: 14px;
        ...
        `,n.textContent=o,t.appendChild(n)}i.appendChild(t),i.scrollTop=i.scrollHeight}async sendMessage(){var m;const e=document.getElementById("lbs-chat-input"),o=e&&e.value.trim(),i=this.pendingFiles.length>0;if(!o&&!i||this.isLoading)return;const t=e?e.value.trim():"";e&&(e.value="",this.resetTextareaHeight());const n=[...this.pendingFiles];this.pendingFiles=[],this.renderPendingFiles(),this.clearFileError(),this.updateSendMicIcon(),n.length>0?this.renderUserMessageWithFiles(t,n):this.renderMessage("user",t);const r={role:"user",content:t||(n.length>0?`[Attached: ${n.map(d=>d.name).join(", ")}]`:"")};n.length>0&&(r.attachments=n.map(d=>({name:d.name,mimeType:d.mimeType,size:d.size}))),this.messages.push(r),this.saveSession(),this.isLoading=!0;const a=K(),l=this.createThinkingMessage(a),p=this.isNewSession&&this.messages.length===1,g=n.length>0?n.map(d=>({name:d.name,mimeType:d.mimeType,size:d.size,base64:d.base64})):void 0;try{const d=await fetch(`${this.config.apiUrl}/api/public/chat/${this.config.chatbotId}`,{method:"POST",headers:{"Content-Type":"application/json","ngrok-skip-browser-warning":"true"},body:JSON.stringify({message:t,sessionId:this.sessionId,isNewSession:p,conversationHistory:this.getConversationHistory().slice(0,-1),files:g})});if(!d.ok)throw new Error("Failed to send message");p&&(this.isNewSession=!1);const u=d.headers.get("content-type");if(u!=null&&u.includes("text/event-stream"))await this.handleSSEStream(d,l);else{const b=await d.json();if(b.success&&((m=b.data)!=null&&m.message))l!=null&&l.parentElement&&l.parentElement.remove(),this.addMessage("assistant",b.data.message);else if(b.error)throw new Error(b.error)}}catch(d){console.error("Failed to send message:",d),l!=null&&l.parentElement&&l.parentElement.remove(),this.addMessage("assistant","Sorry, I'm having trouble responding right now. Please try again.")}finally{this.isLoading=!1}}renderUserMessageWithFiles(e,o){const i=document.getElementById("lbs-chat-messages");if(!i)return;const t=document.createElement("div");t.style.cssText=`
        margin-bottom: 12px;
        display: flex;
      ...
      `;let s="";if(o&&o.length>0){s+=`<div style="margin-bottom: ${e?"8px":"0"}; display: flex; flex-direction: column; gap: 4px;">`;for(const r of o)s+=`
          ...
          `;s+="</div>"}e&&!e.startsWith("[Attached:")&&(s+=h(e)),n.innerHTML=s,t.appendChild(n),i.appendChild(t),i.scrollTop=i.scrollHeight}addMessage(e,o){this.messages.push({role:e,content:o}),this.saveSession(),this.renderMessage(e,o)}getConversationHistory(){return this.messages.map(e=>({role:e.role,content:e.content}))}async handleSSEStream(e,o){var l,p,g,m;const i=(l=e.body)==null?void 0:l.getReader();if(!i)throw new Error("No response body");const t=new TextDecoder;let n="",s="",r=null,a=o;try{for(;;){const{done:d,value:u}=await i.read();if(d)break;n+=t.decode(u,{stream:!0});const b=n.split(`
`);n=b.pop()||"";for(const f of b)if(f.startsWith("data: "))try{const y=JSON.parse(f.slice(6));switch(y.type){case"start":break;case"content":y.content&&(s+=y.content,a&&(a.classList.remove("widget-thinking"),a.style.color="#1f2937",a.style.fontStyle="normal"),this.updateStreamingMessage(a,s));break;case"tool_call":console.log("[Widget] Tool call received:",y.toolCall),((p=y.toolCall)==null?void 0:p.name)==="show_lead_form"?(r=y.toolCall,a!=null&&a.parentElement&&(a.parentElement.remove(),a=null),this.showLeadForm(y.toolCall.parameters,y.toolCall.isContactCapture)):((g=y.toolCall)==null?void 0:g.name)==="show_booking_trigger"&&(r=y.toolCall,y.toolCall.calendlyLink?(console.log("[Widget] Opening Calendly:",y.toolCall.calendlyLink),window.open(y.toolCall.calendlyLink,"_blank")):y.toolCall.isContactCapture&&(a!=null&&a.parentElement&&(a.parentElement.remove(),a=null),this.showLeadForm(y.toolCall.parameters,!0)));break;case"complete":const E=y.content||s;this.updateStreamingMessage(a,E),this.messages.push({role:"assistant",content:E}),this.saveSession();break;case"error":const w=((m=y.error)==null?void 0:m.message)||"An error occurred. Please try again.";a?this.updateStreamingMessage(a,w):this.renderMessage("assistant",w),this.messages.push({role:"assistant",content:w}),this.saveSession();break}}catch(y){}}if(a&&!s&&!r){const d="Sorry, I'm having trouble responding right now. Please try again.";this.updateStreamingMessage(a,d),this.messages.push({role:"assistant",content:d}),this.saveSession()}}finally{i.releaseLock()}}updateStreamingMessage(e,o){if(!e)return;e.innerHTML=z(o);const i=document.getElementById("lbs-chat-messages");i&&(i.scrollTop=i.scrollHeight)}createThinkingMessage(e){const o=document.getElementById("lbs-chat-messages");if(!o)return null;const i=document.createElement("div");i.style.cssText=`
        margin-bottom: 12px;
        display: flex;
      ...
      `;const t=document.createElement("div");return t.className="widget-bubble widget-bubble-assistant widget-thinking",t.style.cssText=`
        ...
        border: 1px solid #e5e7eb;
        font-style: italic;
      `,t.textContent=e,i.appendChild(t),o.appendChild(i),o.scrollTop=o.scrollHeight,t}showLeadForm(e,o=!1){const i=document.getElementById("lbs-chat-messages");if(!i||document.getElementById("widget-lead-form"))return;this.isContactCaptureMode=o;const t=e.extractedData||{},n=this.appearance.primaryColor,s=o?"Schedule a Call":"Connect with an Attorney",r=o?"Please provide your contact information and we'll reach out to schedule a time.":"Please provide your contact information and we'll connect you with an experienced attorney.",a=o?"":`
            <div>
            ...
            </div>`,l=document.createElement("div");l.id="widget-lead-form",l.style.cssText=`
        margin-bottom: 12px;
        display: flex;
        justify-content: flex-start;
      `,l.innerHTML=`
...
${a}
      ...
      `,i.appendChild(l),i.scrollTop=i.scrollHeight;const p=document.getElementById("widget-lead-form-element"),g=document.getElementById("widget-lead-cancel-btn");p&&(p.onsubmit=m=>{m.preventDefault(),this.submitLeadForm(p)}),g&&(g.onclick=()=>{l.remove(),this.renderMessage("assistant","No problem! Let me know if you'd like to connect with an attorney later.")})}async submitLeadForm(e){var p,g,m,d,u;const o=new FormData(e),i=document.getElementById("widget-lead-submit-btn"),t=document.getElementById("widget-lead-form-error"),n=document.getElementById("widget-lead-form"),s=(p=o.get("name"))==null?void 0:p.toString().trim(),r=(g=o.get("email"))==null?void 0:g.toString().trim();if(!s||!r){t&&(t.textContent="Please fill in all required fields.",t.style.display="block");return}if(!/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(r)){t&&(t.textContent="Please enter a valid email address.",t.style.display="block");return}i&&(i.disabled=!0,i.textContent="Submitting...");const a={name:s,email:r,phone:((m=o.get("phone"))==null?void 0:m.toString().trim())||void 0,caseType:((d=o.get("caseType"))==null?void 0:d.toString().trim())||void 0,urgency:((u=o.get("urgency"))==null?void 0:u.toString())||void 0},l=Array.isArray(this.messages)&&this.messages.length>0?{messages:this.messages.filter(b=>b&&b.role&&b.content).map(b=>({role:b.role.toUpperCase(),content:b.content,createdAt:b.createdAt||new Date().toISOString(),localId:b.localId})),capturedAt:new Date().toISOString(),sessionId:this.sessionId}:null;try{if(!(await fetch(`${this.config.apiUrl}/api/public/chat/${this.config.chatbotId}/lead`,{method:"POST",headers:{"Content-Type":"application/json","ngrok-skip-browser-warning":"true"},body:JSON.stringify({...a,sessionId:this.sessionId,source:this.isContactCaptureMode?"BOOKING_FALLBACK":"LEAD_FORM",...l&&{conversationSnapshot:l}})})).ok)throw new Error("Failed to submit lead");n&&n.remove(),this.renderMessage("assistant","Thank you! Your information has been submitted. An attorney will reach out to you soon."),this.messages.push({role:"assistant",content:"Thank you! Your information has been submitted. An attorney will reach out to you soon."}),this.saveSession()}catch(b){console.error("[Widget] Lead submission error:",b),t&&(t.textContent="Failed to submit your information. Please try again.",t.style.display="block"),i&&(i.disabled=!1,i.textContent="Submit")}}showActionCenter(){if(document.getElementById("widget-action-center")){const r=document.getElementById("widget-action-center-overlay");r&&r.remove();return}const o=document.getElementById("lbs-chat-window");if(!o)return;const i=document.createElement("div");i.id="widget-action-center-overlay",i.style.cssText=`
        position: absolute;
        top: 0;
        left: 0;
        right: 0;
